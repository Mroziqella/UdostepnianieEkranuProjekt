            ...
            <div class="col-md-12">
                <div class="row">
                        <h1 class="text-center"><strong><spring:message code="page.title.label"/> </strong><br/>
                            <small><spring:message code="addRoom.room.label"/>
                            </small>
                        </h1>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-12 ">
                        <div class="row">
                            <div class="col-md-6 col-md-offset-4">
                                <p class="lead"><b><spring:message code="addRoom.room.label"/></b></p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4 col-md-offset-4" >
                                <form:form modelAttribute="newRoom" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <form:input type="text" class="form-control" id="inputLogin" path="roomName" placeholder="${nameRoom}"/>
                                        <form:errors path="roomName" cssClass="alert text-danger" />

                                        <spring:message code="addRoom.roomPassword.label" var="passwordRoom"/>
                                        <label for="inputPassowrod">${passwordRoom}</label>
                                        <form:input type="text" class="form-control" id="inputPassowrod" path="roomPassword" placeholder="${passwordRoom}"/>
                                        <form:errors path="roomPassword" cssClass="alert text-danger" />
                                    </div>
